...
// this class represents both controller and view
public class TDView extends SurfaceView implements Runnable {
    private volatile boolean playing;
    private Thread gameThread = null;
    //Game objects
    private PlayerShip player;
    private EnemyShip enemy1, enemy2, enemy3, enemy4, enemy5;
    //for drawing
    private Paint paint;
    ...
    private long timeStarted, timeTaken, fastestTime;
    private int screenX, screenY;
    private Context context;
    private boolean gameEnded;
    private SoundPool soundPool;
    private int win = -1, bump = -1, destroyed = -1, start = -1;
    ...
    public TDView(Context context, int x, int y) {
        ...
        this.screenX = x;
        this.screenY = y;
//        this.player = new PlayerShip(context, x, y);
//        this.enemy1 = new EnemyShip(context, x, y);
//        this.enemy2 = new EnemyShip(context, x, y);
//        this.enemy3 = new EnemyShip(context, x, y);
//        int numSpecs = 40;
...
//        }
    ...
    private void update() {
        ...
        // If you are using images in excess of 100 pixels wide then increase the -100 value accordingly
        ...
        for (SpaceDust sp : dustList)
            sp.update(player.getSpeed());
...
//
//            //For debugging
//            //Switch to white pixles
//            paint.setColor(Color.argb(255,255,255,255));
//            //Draw hitboxes
//            canvas.drawRect(player.getHitbox().left,player.getHitbox().top
//                            ,player.getHitbox().right,player.getHitbox().bottom,paint);
//            canvas.drawRect(enemy1.getHitbox().left,enemy1.getHitbox().top
//                            ,enemy1.getHitbox().right,enemy1.getHitbox().bottom,paint);
//            canvas.drawRect(enemy2.getHitbox().left,enemy2.getHitbox().top
//                            ,enemy2.getHitbox().right,enemy2.getHitbox().bottom,paint);
//            canvas.drawRect(enemy3.getHitbox().left,enemy3.getHitbox().top
//                            ,enemy3.getHitbox().right,enemy3.getHitbox().bottom,paint);


            //white specs of dust color
            paint.setColor(Color.argb(255, 255, 255, 255));
